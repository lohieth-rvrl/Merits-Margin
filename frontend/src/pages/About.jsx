...
export default function About() {
  return (
    <div>
      <Helmet>
        <title>About — Merit & Margin</title>
        <meta
          name="description"
          content="What Merit & Margin covers, how it's made, and why it's ad-supported but not advertiser-directed."
        />
      </Helmet>
      <div className="lr-hero py-5 mb-5">
        <div className="container fade-in-up">
          <h1 className="display-6 fw-bold mb-3">About Merit &amp; Margin</h1>
